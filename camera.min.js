...
; (function ($) {
    $.fn.camera = function (opts, callback) {
        ...
        if (opts.navigation == true) {
            fakeHover.append(
                '<button class="camera_prev" tabindex="0"><span></span></button>'
                ).append(
                '<button class="camera_next" tabindex="0"><span></span></button>'
                );
        }
        ...
        // Custom Code Begin -- Add Title Text to Link
        ...
        for (loopMove = 0; loopMove < amountSlide; loopMove++) {
            ...
            if (allLinks[loopMove] != '') {
                ...
                //
                $('.camera_target_content .cameraContent:eq(' + loopMove + ')', wrap).append('<a class="camera_link" href="' + allLinks[loopMove] + '" ' + dataBox + ' target="' + allTargets[loopMove] + '" title="' + allTitles[loopMove] + '" tabindex="0"></a>');
            }
        ...
        if ($(pagination).length) {
            ...
            for (li = 0; li < amountSlide; li++) {
                $('.camera_pag_ul', wrap).append('<li tabindex="0" class="pag_nav_' + li + '" style="position:relative; z-index:1002"><span><span>' + li + '</span></span></li>');
            }
        ...
        if ($(commands).length) {
            $(commands).append('<button class="camera_play"></button>').append('<button class="camera_stop"></button>');
            if (autoAdv == true) {
                $('.camera_play', camera_thumbs_wrap).hide();
                $('.camera_stop', camera_thumbs_wrap).show();
            } else {
